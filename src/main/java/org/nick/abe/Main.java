...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            switch (args[0]) {
            case "pack-old":
                AndroidBackup.packTar(args[1], args[2], password, false);
                break;
            case "pack":
            case "pack-kk":
                AndroidBackup.packTar(args[1], args[2], password, true);
                break;
            case "unpack":
    ...
    private static void usage() {
        ...
        System.out.println("  pack for before 4.4:\tabe pack-old\t<backup.tar> <backup.ab> [password]");
